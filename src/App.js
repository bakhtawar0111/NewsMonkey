...
export default class App extends Component {
  ...
  render() {
    return ( 
      ...
      />
      <Routes>
        <Route exact path="/" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="home" pageSize={6} country='in' category='general'/>}/>
        <Route exact path="/home" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="home" pageSize={6} country='in' category='general'/>}/>
